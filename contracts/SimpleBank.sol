...
contract SimpleBank {
    ...
    function enroll() public returns (bool) {
        ...
        if (enrolled[msg.sender]) return false;
    ...
    function deposit() public payable returns (uint256) {
        ...
        require(enrolled[msg.sender], "Must be enrolled first!");
        uint256 initialBalance = balances[msg.sender];
        uint256 newBalance = initialBalance + msg.value;
        require(newBalance > initialBalance, "Oeverflow!");
    ...
    function withdraw(uint256 withdrawAmount) public returns (uint256) {
        ...
        uint256 initialBalance = balances[msg.sender];
        require(initialBalance >= withdrawAmount, "Not enough money!");
        uint256 newBalance = initialBalance - withdrawAmount;
        require(newBalance < initialBalance, "Underflow!");
        balances[msg.sender] = newBalance;
